...
const PropertyCard = ({ property }) => {
  return (
    <Link
      ...
      className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all border border-gray-100 p-4 flex flex-col gap-3 hover:scale-[1.03] duration-200 cursor-pointer"
    >
